...
const slides = document.querySelectorAll('.banner .img picture'); // pega cada slide
...
function updateSlide() {
  const width = slides[0].clientWidth; // largura do banner
...
// se a tela for redimensionada, o banner recalcula
...
BotoesAdicionar.forEach(botao => {
  botao.addEventListener("click", () => {
    ...
    const preco = precoElement ? precoElement.textContent : 'R$ 0,00'; // Usa um valor padrão se não encontrar
